...
{
    public class PlaneSurfaceSky : MonoBehaviour, ISurface, IBounds
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Normal faces along the transform's negative Y axis
            /// </summary>
            Down,

            /// <summary>
            /// Normal faces along the transform's positive Y axis
            /// </summary>
            Up,
        }
        ...
        [SerializeField]
        private NormalFacing _facing = NormalFacing.Down;
        ...
        public Vector3 Normal
        {
            get
            {
                return _facing == NormalFacing.Up ?
                                  transform.up :
                                  -transform.up;
            }
        }
